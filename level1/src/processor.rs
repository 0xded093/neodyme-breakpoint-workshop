...
fn withdraw(program_id: &Pubkey, accounts: &[AccountInfo], amount: u64) -> ProgramResult {
    ...
    assert_eq!(wallet_info.owner, program_id); // check that wallet has been generated by this program
    assert_eq!(wallet.authority, *authority_info.key); // check that wallet authority matches authority info (user input)
